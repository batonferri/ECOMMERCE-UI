  ...
  return (
    <Container>
      ...
      <Wrapper>
        ...
        <Top>
          <TopButton onClick={removeItemsFromBasket}>Clean Basket</TopButton>
          <TopTexts>
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <StripeCheckout
              name="Sup"
              image="https://i.ibb.co/QdXRQtf/3q.png"
              billingAddress
              shippingAddress
            ...
            >
              {cart.total === 0 ? (
                <Button disabled>NO PRODUCTS ON CART</Button>
              ) : (
